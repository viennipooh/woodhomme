...
#define HTTPD_SERVER_AGENT "TMTIP/1.0.0"
#endif
...
static const char *g_psHTTPHeaderStrings[] =
{
 ...
 "WWW-Authenticate: Basic realm=\"Please Enter Password\"\r\n",
...
#define HTTP_HDR_401_ERR        26 /* 401 Authorization Required by https://tools.ietf.org/html/rfc2617 */
#define HTTP_HDR_401_ERR_11     27 /* 401 Authorization Required by https://tools.ietf.org/html/rfc2617 */
#define HTTP_HDR_WWW_AUTH       28 /* WWW-Authenticate by https://tools.ietf.org/html/rfc2617 */
#define HTTP_HDR_CSV            29 /* text/csv */
