...
{  
  ...
  switch_select_speed(ETH1,sw->ports[0].speed);
  switch_select_speed(ETH2,sw->ports[1].speed);  
  
  switch_select_flow_control(ETH1,sw->ports[0].flow_control);
  switch_select_flow_control(ETH2,sw->ports[1].flow_control);  
#endif
}