...
//C
uint32_t GPIO_PeriphClock(GPIO_TypeDef * GPIO) {
  switch ((uint32_t)GPIO) {
  case (uint32_t)GPIOA: return (uint32_t)RCC_AHB1Periph_GPIOA;
  case (uint32_t)GPIOB: return (uint32_t)RCC_AHB1Periph_GPIOB; 
  case (uint32_t)GPIOC: return (uint32_t)RCC_AHB1Periph_GPIOC;
  case (uint32_t)GPIOD: return (uint32_t)RCC_AHB1Periph_GPIOD;
  case (uint32_t)GPIOE: return (uint32_t)RCC_AHB1Periph_GPIOE;
  case (uint32_t)GPIOF: return (uint32_t)RCC_AHB1Periph_GPIOF;
  case (uint32_t)GPIOG: return (uint32_t)RCC_AHB1Periph_GPIOG;
  case (uint32_t)GPIOH: return (uint32_t)RCC_AHB1Periph_GPIOH;
  case (uint32_t)GPIOI: return (uint32_t)RCC_AHB1Periph_GPIOI; 
  default:    return 0;
  }
}
